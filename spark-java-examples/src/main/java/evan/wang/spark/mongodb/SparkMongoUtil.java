...
/*		SparkConf conf = new SparkConf().setMaster("local[2]").setAppName("MongoSparkConnectorIntro")
		...
		SparkConf conf = new SparkConf().setMaster("local[2]").setAppName("MongoSparkConnectorIntro")
				.set("spark.mongodb.input.uri","mongodb://wangsy:123456@127.0.0.1/admin.one?readPreference=primaryPreferred")
				.set("spark.mongodb.output.uri", "mongodb://wangsy:123456@127.0.0.1/admin.one");
		return conf;
	}
